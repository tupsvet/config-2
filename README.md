### Описание проекта  
Проект представляет собой инструмент командной строки для визуализации графов зависимостей пакетов Ubuntu, включая транзитивные зависимости. Граф зависимостей формируется в формате Mermaid и может быть визуализирован с использованием сторонних утилит, таких как mermaid-cli.
